...
namespace CMS.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,RollNo,FirstName,LastName,Age,Gender,City,Country,PhoneNo,Address,BatchID,CampusID,SectionID,DepartmentID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,RollNo,FirstName,LastName,Age,Gender,City,Country,PhoneNo,Address,BatchID,CampusID,SectionID,DepartmentID")] Student student)
        {
