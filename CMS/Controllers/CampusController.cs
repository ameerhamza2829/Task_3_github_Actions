...
namespace CMS.Controllers
{
    ...
    public class CampusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CampusID,CampusName")] Campus campus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CampusID,CampusName")] Campus campus)
        {
